...
rotate Pages, Recent Posts, Blogroll (External Links), Menus, Blog Archives, List of Authors, Current Page/Post Links, Links from a customer's HTML container, Post Tags and 
Post Categories. It allows showing up to 9 types of content in one widget activated from static or dynamic menu (another cloud). Supports following shapes: 2D SPIRAL, 3D AXES, 
...
(tetrahedron), RING that starts off horizontal, RING that starts off vertical, RINGS knotwork, ROLLER of rings, SANDGLASS, SATURN, SPHERE, SPRING, SQUARE, STAIRECASE, STOOL, TIRE , TOWER of 
...
of Recent posts, Pages, Menu, List of Authors and Blogroll (External Links), Current Page/Post Links and Custom HTML container tags may consist of both image and text. It gives an 
