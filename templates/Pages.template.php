	...
	<div class="section_content">
		<div style="float: left;">
			...
			<div style="padding-top: 5px;">
				<label style="margin: 0 10px 0 0;" title="The shape of the cloud" for="<?=$this->get_field_id('pag_shape'); ?>">
					Shape
					<br>
				...
				<label style="margin: 0 10px 0 0;" title="Type of highlight to use" for="<?=$this->get_field_id('pag_outline_method'); ?>">
					Outline<br>Method
					<br>
				...
				<label style="margin: 0 10px 0 0;" title="Minimal opacity of tags at back of cloud." for="<?=$this->get_field_id('pag_brightness'); ?>">
					Min<br>Opacity
					<br>
				...
				<label style="margin: 0 10px 0 0;" title="Pulsate outline to this opacity. Choose <span class='green'>1.0</span> for no pulsation."for="<?=$this->get_field_id('pag_pulsate_to'); ?>">
				...
				<label style="width: 100%;" for="<?=$this->get_field_id('pag_tooltip'); ?>" title="Sets text for operating system tooltip of your cloud. For instance if the cloud allows <span class='green'>Drag Control</span> then you can suggest your site visitors to 'Drag & Click'.">
				Tooltip
				<div>
			...
			<div style="padding-top: 5px;">
				<label style="width: 86px;" title="Initial size of cloud from centre to sides." for="<?=$this->get_field_id('pag_radius_x'); ?>">
					...
					<select id="<?=$this->get_field_id('pag_radius_x'); ?>" name="<?=$this->get_field_name('pag_radius_x'); ?>">
						<?php for($i=10; $i<755; $i+=5){echo '<option id="parx_' . $i . '" value="' . $i/100 . '"'; if($pag_radius_x==$i/100){echo ' selected';}; echo '>' . $i/100 . '</option>'; } ?>
					</select>
				</label>				
				<label style="width: 86px;" title="Initial size of cloud from centre to top and bottom." for="<?=$this->get_field_id('pag_radius_y'); ?>">
					...
					<select id="<?=$this->get_field_id('pag_radius_y'); ?>" name="<?=$this->get_field_name('pag_radius_y'); ?>">
						<?php for($i=10; $i<755; $i+=5){echo '<option id="pary_' . $i . '" value="' . $i/100 . '"'; if($pag_radius_y==$i/100){echo ' selected';}; echo '>' . $i/100 . '</option>'; } ?>
					</select>
				</label>				
				<label style="width: 86px;" title="Initial size of cloud from centre to front and back." for="<?=$this->get_field_id('pag_radius_z'); ?>">
					...
					<select id="<?=$this->get_field_id('pag_radius_z'); ?>" name="<?=$this->get_field_name('pag_radius_z'); ?>">
						<?php for($i=10; $i<755; $i+=5){echo '<option id="parz_' . $i . '" value="' . $i/100 . '"'; if($pag_radius_z==$i/100){echo ' selected';}; echo '>' . $i/100 . '</option>'; } ?>
					</select>
				</label> 
		...
		<div style="float: left; height: 67px;">
			...
			<div style="padding-top: 5px;">
				<label for="<?=$this->get_field_id('pag_text_color'); ?>">
					Tag Color
					<br>
				...
				<label for="<?=$this->get_field_id('pag_bg_color'); ?>">
					Background
					<br>
					<span class="hash">#</span>
					<div class="siwraper">
				...
				<label for="<?=$this->get_field_id('pag_bg_outline'); ?>">
					Border
					<br>
					<span class="hash">#</span>
					<div class="siwraper">
				...
				<label for="<?=$this->get_field_id('pag_shadow'); ?>">
					Shadow
					<br>
					<span class="hash">#</span>
					<div class="siwraper">
		...
		<div style="float: left;">
			...
			<div style="padding-top: 5px;">
				...
				<label style="margin: 0 0 5px 0;" title="Shadow behind each Menu tag" for="<?=$this->get_field_id('pag_shadowblur'); ?>">
					Shadow Blur
					<br>
				...
				<label title="Web Safe Font family for the tag text" style="float: left; width: 170px; margin-right: 5px;" for="<?=$this->get_field_id('pag_text_font'); ?>">
					Web Safe Font
				...
				<label title="Uses a Google Font for Cloud Tags. If filled up this option overrides <span class='green'>Web Safe Font</span>." for="<?=$this->get_field_id('pag_google_font'); ?>" style="width: 161px;">
					Google Font
